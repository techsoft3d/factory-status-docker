...
robotViewer.prototype._createViewer = function () {
    ...
    createViewer("factory", "container").then(function (hwv) {
        ...
        function modelStructureReadyFunc() {
            ...
            _this._createRobotSystem("Arc Welding #1", "WeldRobot1", "demos/factory-status/csv/WeldRobotMatrixData.csv", { x: 1500, y: -1500, z: 0 }).then(function () {
                return _this._createRobotSystem("Arc Welding #2", "WeldRobot1", "demos/factory-status/csv/WeldRobotMatrixData.csv", { a: 180, x: 1500, y: -4500, z: 0 });
            }).then(function () {
                return _this._createRobotSystem("Spot Welding #1", "NsRobot5", "demos/factory-status/csv/SpotWeldRobotMatrixData.csv", { x: 3000, y: -1500, z: 0 });
            }).then(function () {
                return _this._createRobotSystem("Spot Welding #2", "NsRobot5", "demos/factory-status/csv/SpotWeldRobotMatrixData.csv", { a: 180, x: 3000, y: -4500, z: 0 });
            }).then(function () {
                return _this._createRobotSystem("Spot Welding #3", "NsRobot5", "demos/factory-status/csv/SpotWeldRobotMatrixData.csv", { x: 4500, y: -1500, z: 0 });
            }).then(function () {
                return _this._createRobotSystem("Spot Welding #4", "NsRobot5", "demos/factory-status/csv/SpotWeldRobotMatrixData.csv", { a: 180, x: 4500, y: -4500, z: 0 });
            }).then(function () {
                return _this._createRobotSystem("Pick-and-place #1", "PickUpRobot1", "demos/factory-status/csv/PickUpRobotMatrixData.csv", { a: 90, x: 3200, y: -6500, z: 0 });
            }).then(function () {
                return _this._createRobotSystem("Pick-and-place #2", "PickUpRobot1", "demos/factory-status/csv/PickUpRobotMatrixData.csv", { a: -90, x: 4800, y: -7500, z: 0 });
            }).then(function () {
                return _this._createRobotSystem("CMM #1", "CMM_Assy", "demos/factory-status/csv/CMMatrixData.csv", { a: -90, x: 1200, y: -5700, z: 0 }, true);
            }).then(function () {
                return _this._createRobotSystem("CMM #2", "CMM_Assy", "demos/factory-status/csv/CMMatrixData2.csv", { a: -90, x: 1200, y: -7200, z: 0 }, true);
            }).then(function () {
                ...
                $.getJSON("demos/factory-status/json/operating_ratio.json", function (ratioData) {
                    if (ratioData) {
                        _this._ratios = [];
                ...
                $.ajax({
                    ...
                    console.log(xhr.responseText, "status: " + status, "err: " + errorThrown);
                });
